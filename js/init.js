			...
			markup: '<div class="pp_pic_holder"> \
						   <div class="ppt">&nbsp;</div> \
							<div class="pp_details"> \
								<div class="pp_nav"> \
								    <a href="#" class="pp_arrow_previous"> <i class="icon-raintree-left-arrow-thin icon-default-style"></i> </a> \
									<a href="#" class="pp_arrow_next"> <i class="icon-raintree-right-arrow-thin icon-default-style"></i> </a> \
...
/***************** Nav ******************/
	...
	function headerInit() {
		...
		$('header#top nav > ul > li.cta > a').css({
			'padding-bottom' : (logoHeight/3) - ($('header#top nav > ul > li.cta > a').height()/3),
			'padding-top' : (logoHeight/3) - ($('header#top nav > ul > li.cta > a').height()/3),
			'margin-top' : (((logoHeight/3) - ($('header#top nav > ul > li.cta > a').height()/3)) / 3)
		});
	...
	function smallNav(){
		...
		if($offset > 0 && $windowWidth > 1000) {
			...
			$('header#top nav > ul > li.cta > a').stop(true,true).animate({
				'padding-bottom' : ((logoHeight-shrinkNum)/3) - ($('header#top nav > ul > li.cta > a').height()/3),
				'padding-top' : ((logoHeight-shrinkNum)/3) - ($('header#top nav > ul > li.cta > a').height()/3),
				'margin-top' : ((((logoHeight-shrinkNum)/3) - ($('header#top nav > ul > li.cta > a').height()/3)) / 3)
			},{queue:false, duration:250, easing: 'easeOutCubic'});
			...
			$('header#top nav > ul li#search-btn').stop(true,true).animate({
				'padding-bottom' : Math.floor(((logoHeight-shrinkNum)/3) - ($('header#top nav > ul li#search-btn a').height()/3)),
				'padding-top' : Math.floor(((logoHeight-shrinkNum)/3) - ($('header#top nav > ul li#search-btn a').height()/3))
			},{queue:false, duration:250, easing: 'easeOutCubic'});	
