...
function nectar_image_with_animation($atts, $content = null) { 
    extract(shortcode_atts(array("animation" => 'Fade In', "delay" => '0', "image_url" => '', 'alt' => '', 'img_link_target' => '_self', 'img_link' => '', 'img_link_large' => ''), $atts));
...
function nectar_blog_processing($atts, $content = null) {
	...
	<div class="row">
	 ...
	 <?php $options = get_option('raintree'); 
...
function nectar_recent_projects($atts, $content = null) {
	...
	if($title_labels == 'true') $title_label_output = '<h2>'.$recent_projects_title_text.'<a href="'. $portfolio_link.'" class="button"> / '. $recent_projects_link_text .'</a></h2>';
				...
				if($full_width_carousel == 'true'){
					$arrow_markup = '<div class="controls"><a class="portfolio-page-link" href="'.$page_link_url.'"><i class="icon-raintree-back-to-all"></i></a>
									 <a class="carousel-prev" href="#"><i class="icon-raintree-left-arrow-thin"></i></a>
					    	         <a class="carousel-next" href="#"><i class="icon-raintree-right-arrow-thin"></i></a></div>';
				} else {
