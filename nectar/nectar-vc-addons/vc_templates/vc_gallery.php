...
if ( $type == 'flexslider_style' ) {
	...
	$slides_wrap_end .= '</div>  <a href="" class="slider-prev"><i class="icon-raintree-left-arrow"></i> <div class="slide-count"> <span class="slide-current">1</span> <i class="icon-raintree-right-line"></i> <span class="slide-total"></span> </div> </a>
