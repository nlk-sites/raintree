...
function setup_framework_options(){
    ...
    // Default: Options
    $args['menu_title'] = __('RainTree', NECTAR_THEME_NAME);

    // Set a custom page title for the options page.
    // Default: Options
    $args['page_title'] = __('RainTree', NECTAR_THEME_NAME);
    ...
    $sections[] = array(
        ...
        'desc' => __('<p class="description">Welcome to the RainTree options panel! You can switch between option groups by using the left-hand tabs.</p>', NECTAR_THEME_NAME),
        'fields' => array(
            array(
                'id' => 'favicon',
                'type' => 'upload',
	 ...
	 $sections[] = array(
        ...
        'fields' => array(
			...
			array(
                ...
                'sub_desc' => __('Please enter the copyright section text. e.g. All Rights Reserved, RainTree Inc.', NECTAR_THEME_NAME),
                'desc' => __('', NECTAR_THEME_NAME)
            ),
	...
	$item_info .= '<iframe src="http://docs.google.com/gview?url=themenectar.com/docs/raintree.pdf&embedded=true" style="width:100%; height:600px;" frameborder="0"></iframe>';
    $item_info .= '</div>';
