				    ...
				    if(empty($terms)) $terms = array('1' => (object) array('name' => 'nothing'));
					 ...
					 ?>
						 ...
						 <div id="portfolio-nav">
						 	<ul>
						 		<li id="all-items"><a href="<?php echo $portfolio_link; ?>"><i class="icon-raintree-back-to-all"></i></a></li>               
						 	</ul>
							<ul class="controls">                                 
								<li id="prev-link"><?php be_next_post_link('%link','<i class="icon-raintree-left-arrow-thin"></i>',TRUE, null,'project-type'); ?></li>
								<li id="next-link"><?php be_previous_post_link('%link','<i class="icon-raintree-right-arrow-thin"></i>',TRUE, null, 'project-type'); ?></li> 
							</ul>
						</div>
				...
				<?php  } 
					 ...
					 //if no category page exists
						...
						<div id="portfolio-nav">
							...
							<ul class="controls">                                       
								<li id="prev-link"><?php next_post_link('%link','<i class="icon-raintree-left-arrow-thin"></i>'); ?></li>
								<li id="next-link"><?php previous_post_link('%link','<i class="icon-raintree-right-arrow-thin"></i>'); ?></li> 
							</ul>
						</div>
				 <?php } ?>
