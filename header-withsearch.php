			...
			<div class="row">
				...
				<div class="col span_9 col_last">
					...
					<?php if (!empty($options['enable-cart']) && $options['enable-cart'] == '1') { 
						if ($woocommerce) { ?> 
							<!--mobile cart link-->
							<a id="mobile-cart-link" href="<?php echo $woocommerce->cart->get_cart_url(); ?>"><i class="icon-raintree-cart"></i></a>
						<?php } 
					} ?>
